...
include('db.php');
    ...
    if (isset($_SESSION['user_id'])) {
      ...
      // Query the database to get the user (admin) data
      $result = $conn->query("SELECT * FROM users WHERE id = '$user_id'");
      $user = $result->fetch_assoc();
      
      // Check if the user is an admin
      if ($_SESSION['role'] == 'admin') {
          // Fetch the admin's image
          $imageUrl = $user['image'] ?? 'images/default.png';
      } else {
          // Use a default image for non-admin users
...
<div class="topnav" id="topnav">
   ...
   <form method="GET" action="admin.php" class="search-form">
        ...
        <div class="user">
            ...
            <img src="<?php echo $imageUrl; ?>" alt="Admin Image" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover; margin-top: 15px;">
        </div>
    </a>
</div>
...
<div id="deleteModal" class="modal">
    <div class="modal-content">
        ...
        <h3>Are you sure you want to delete<br> this user?</h3>
...
<script>
    ...
    // Add this part for closing the modals when clicking on the background
