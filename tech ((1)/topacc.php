...
<head>
    ...
    <link rel="stylesheet" href="css/topacc.css">
...
<body>
    ...
    <div class="topnav" id="topnav">
        ...
        <?php if (in_array(basename($_SERVER['PHP_SELF']),  'admin.php'])): ?>
            <div class="topnav-right">  
                <form method="GET" action="" class="search-form">
                    <input type="text" name="search" value="<?php echo htmlspecialchars($_GET['search'] ?? ''); ?>" placeholder="Search users..." />
                    <button type="submit">
